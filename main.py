...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'work.meta@outlook.com' ")
...
lbl3 = tk.Label(frame1, text="Attendance",width=20  ,fg="#D3D3D3"  ,bg="#D3D3D3"  ,height=1 ,font=('times', 17, ' bold '))
